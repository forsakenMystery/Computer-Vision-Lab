...
I1 = cv2.imread('C:\\Users\\Hamed Khashehchi\\Desktop\\cv-lab6\\scene1.jpg')
I2 = cv2.imread('C:\\Users\\Hamed Khashehchi\\Desktop\\cv-lab6\\scene2.jpg')
...
for i in range(n):
    ...
    if area<stats[i][4] and i is not 0:
        area=stats[i][4]
        j=i
